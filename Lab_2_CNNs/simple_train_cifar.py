...
tf.app.flags.DEFINE_string('log_dir', '{cwd}/logs/lab_2'.format(cwd=os.getcwd()),
...
def deepnn(x):
  ...
  Returns:
    ...
    with tf.variable_scope('Conv_1'):
        ...
        w_2 = tf.Variable(tf.truncated_normal([1024,1024], stddev=0.1))
        b_2 = tf.Variable(tf.constant(0.1, shape=[w_2_dim]))
